...
#'   function. `cohort_means_external` is the per-cohort sample-mean
#'   covariate matrix computed from `indep_x_pdata`, or `NULL` when
#'   `indep_x_pdata` is `NA`/`NULL`. See Phase 8 of
#'   `.plans/predict-methods-33/PLAN.md` for the methodology.
#' @keywords internal
#' @noRd

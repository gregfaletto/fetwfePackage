...
One scope caveat: **Theorem `debiased.highdim.thm`** (validated in simulation) covers the **scalar overall-ATT** (`debiasedATT()`), but the **family-wise band** (Theorem `debiased.highdim.joint.thm`) coverage at $p \geq NT$ is *not* itself simulation-validated --- the paper states it experimental-grade --- so treat these high-dimensional bands as the experimental part of this path.

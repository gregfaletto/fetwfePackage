...
Feel free to skip to the next section if you want to jump right in to using the package, or in the next section you can read a little more background information on the methodology if you'd like.
